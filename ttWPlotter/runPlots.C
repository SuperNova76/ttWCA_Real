{
  ...
  if(CRFake){
    p.plot("LepPt1_CRFake",     1,  0,  500, "CR: 3l, 1b, 3j");
    p.plot("LepPt2_CRFake",     1,  0,  250, "CR: 3l, 1b, 3j");
    p.plot("LepPt3_CRFake",     1,  0,  250, "CR: 3l, 1b, 3j");

    p.plot("JetPt1_CRFake",     1,  0,  500, "CR: 3l, 1b, 3j");
    p.plot("JetPt2_CRFake",     1,  0,  250, "CR: 3l, 1b, 3j");

    p.plot("LepEta1_CRFake",    1, -3.0, 3.0, "CR: 3l, 1b, 3j");
    p.plot("LepPhi1_CRFake",    1, -4.0, 4.0, "CR: 3l, 1b, 3j");
  
    p.plot("JetEta1_CRFake",    1, -3.0, 3.0, "CR: 3l, 1b, 3j");
    p.plot("JetPhi1_CRFake",    1, -4.0, 4.0, "CR: 3l, 1b, 3j");

    p.plot("LepEta2_CRFake",    1, -3.0, 3.0, "CR: 3l, 1b, 3j");
    p.plot("LepPhi2_CRFake",    1, -4.0, 4.0, "CR: 3l, 1b, 3j");

    p.plot("Ht_CRFake",         1, 300, 1000,  "CR: 3l, 1b, 3j");
    p.plot("EtMiss_CRFake",     1,   0,  300,  "CR: 3l, 1b, 3j");

    p.plot("Deta_CRFake",       1, -2.5, 2.5,  "CR: 3l, 1b, 3j");
  }
