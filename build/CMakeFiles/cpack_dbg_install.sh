...
/cvmfs/atlas.cern.ch/repo/ATLASLocalRootBase/x86_64/Cmake/3.18.3/Linux-x86_64/bin/cmake -E copy /srv/build/x86_64-centos7-gcc8-opt/bin/*.dbg \
    ${OUTDIR}/bin/
/cvmfs/atlas.cern.ch/repo/ATLASLocalRootBase/x86_64/Cmake/3.18.3/Linux-x86_64/bin/cmake -E copy /srv/build/x86_64-centos7-gcc8-opt/lib/*.dbg \
    ${OUTDIR}/lib/
